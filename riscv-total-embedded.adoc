...
| 2 | NMI | Integrity_NMI | (optional) ECC/parity/lockstep
| 3 | NMI | ClockRecovery_NMI | (optional)
| 4 | NMI | WatchdogViolation_NMI | (optional) 
...
| 7 | NMI | Unrecoverable_NMI | nested nmi or a state that cannot be recovered to.
| 8 | IRQ | SoftDeffered0_IRQ | software deffered interrupt can be used for context switch.
