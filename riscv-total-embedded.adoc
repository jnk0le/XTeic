...
"to protect software from itself" <<cv32regzeroing>>


it doesn't protect softwere from itself, it just hides bugs until
they manifest in the worst possible scenario

like debugging at -O0

V extension uses all `1` for `tail agnostic` mode just to prevent software relying on uarch dependent zeroing
