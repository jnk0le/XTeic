...
| 4 | NMI | WatchdogViolation_NMI | (optional) Entered right before any of the watchdogs trips
									...
									and error logging, not to reset the watchdog. It shall be
									assumed that execution could be frozen at this point and no
									further action can or need to be performed.
