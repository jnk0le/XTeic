...
- custom registers and CSRs should also be covered (e.g. HW loops in RI5CY)
...
NOTE: compilers usally dont care about non-abi (interrupt) prologues/epilogues

The solution could be:

- optimize HW stacker for typical allocations
- make compilers treat specially a call trees growing from interrupt handlers (requires special attribute)
